...
calendar_agent = Agent(
    ...
    instructions=(
        ...
        "Gib dafür title, startzeit (UTC in iso 8601), endzeit (UTC in iso 8601) und optional location an. Rechne die zeit -2 (zeitzone) Denke dir aus dem Kontext heraus einen guten Titel und wenn du nichts weißt dann frage nach. "
        "Mit get_events kannst du Events in einem Zeitraum abrufen."
        "Übergebe dazu start und end als UTC-Zeitpunkte (UTC in ISO 8601). Beachte die Zeitzone (Berlin nichts zurechnen ide zeit ist schon gmt+2)"
